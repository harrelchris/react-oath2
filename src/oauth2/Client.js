class Client {
  ...
  /**
   * Set the state string sent in request for authorization code.
   * The state string will be compared to the state string received
   * along with the authorization code for validation.
   *
   * @param state {string} random string used for authorization code validation
   */
  setState(state) {
